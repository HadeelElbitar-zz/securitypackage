...
namespace SecurityPackage
{
    public partial class MainForm : Form
    {
        ...
        {
            DES des = new DES();
            ModifiedTextBox.Text = des.Encrypt(OriginalTextBox.Text.Trim());
        }
        private void DecryptButton_Click(object sender, EventArgs e)
        {
            DES des = new DES();
            ModifiedTextBox.Text = des.Decrypt(OriginalTextBox.Text.Trim());
        }
        #endregion
        ...
        {
            RC4 rc4 = new RC4();
            ModifiedTextBox.Text = rc4.Encrypt(OriginalTextBox.Text.Trim());
        }
        private void RC4DecryptButton_Click(object sender, EventArgs e)
        {
            RC4 rc4 = new RC4();
            ModifiedTextBox.Text = rc4.Decrypt(OriginalTextBox.Text.Trim());
        }
        #endregion
        ...
        {
            AES aes = new AES(OriginalTextBox.Text, AESKeyTextBox.Text);
            ModifiedTextBox.Text = aes.Encrypt();
        }
        private void AESDecryptButton_Click(object sender, EventArgs e)
        {
            AES aes = new AES(OriginalTextBox.Text, AESKeyTextBox.Text);
            //ModifiedTextBox.Text = aes.Decrypt();
        }
        #endregion
